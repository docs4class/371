...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <dbl>
#>  1  2013     1     1     1500           1459         1
#>  2  2013     1     1     1840           1845        -5
#>  3  2013     1     1     1457           1500        -3
#>  4  2013     1     2     1905           1909        -4
#>  5  2013     1     2     1147           1155        -8
#>  6  2013     1     2      827            820         7
#>  7  2013     1     3      701            705        -4
#>  8  2013     1     3     1850           1858        -8
#>  9  2013     1     3      702            658         4
#> 10  2013     1     4      611            615        -4
#> # ... with 1,085 more rows, and 13 more variables:
#> #   arr_time <int>, sched_arr_time <int>, arr_delay <dbl>,
#> #   carrier <chr>, flight <int>, tailnum <chr>,
#> #   origin <chr>, dest <chr>, air_time <dbl>,
